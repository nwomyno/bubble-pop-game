"""
bubble-pop-game/src/skeleton.py
================================
설계 문서 (Blueprint)

개발 시작 전에 작성한 초기 설계도입니다.
실제 구현 코드는 main.py를 참고하세요.

주요 설계 요소:
- 5개 클래스 기반 객체지향 구조 (Bubble, Cannon, HexGrid, ScoreDisplay, Game)
- MVP 7개 핵심 기능 체크리스트
- 육각형 격자 배치, DFS 터뜨리기, 물리 엔진 등의 핵심 알고리즘 구현 계획
